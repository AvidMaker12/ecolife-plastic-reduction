...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Console/Client Accounts/Add | EcoLife</title>
    ...
    <body>
        ...
        <header class="w3-padding">
            ...
            <h1 class="w3-text-red">Add Client Account</h1>
        ...
        <section class="w3-padding">
            ...
            <form method="post" action="/console/clients/add" novalidate class="w3-margin-bottom">
                ...
                <button type="submit" class="w3-button w3-green">Add Client</button>

            </form>

            <a href="/console/clients/list">Back to Client Account List</a>
